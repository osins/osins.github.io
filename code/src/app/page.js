...
export default function Home() {
  return (
    <Main container>
      ...
      <Grid2>
        <Grid2 xs={12}>
          <OsText title='基本信息'>性别：男 , 生日：1977年9月17日, 户口：山东胶州市</OsText>
          <OsText title='工作年限'>20 多年 IT 软件开发经验</OsText>
          ...
          <OsText title='工具'>
            Docker、Docker Swarm、Docker Compose、Jenkins、 Git、Ansible、阿里云CLI等工具，熟悉 Vscode、Idea、Postman等开发工具。
          </OsText>
        </Grid2>
      </Grid2>
      <Grid2 container>
